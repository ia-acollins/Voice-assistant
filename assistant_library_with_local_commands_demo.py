...
yo_duh = datalist[0]
ses = datalist[1]
sesupgrade = datalist[3]
yo_duhupgrade = datalist[2]
yocount = 0
sescount = 0
...
def process_event(assistant, event):
    ...
    if event.type == EventType.ON_START_FINISHED:
        ...
        if text == 'power off':
            ...
            aiy.audio.say('GO TO ELEVENTH GRADE')
            yo_duh += 0.5
        ...
        elif text == 'cease points' or text == 'how many cease points' or text == 'what are your cease points' or text == 'how many cease points do you have':
            ses = int(ses)
            ses = str(ses)
        ...
        #EPIC STOREEEE
            ...
            if yo_duh >= 2 and ses >= 5:
                aiy.audio.say("i liek lerning ab cease in the oshee an. i liek lerning 12 threece in da oshee an.")
                yo_duh = yo_duh - 2
                ses = ses - 5
            else:
            ...
            if yo_duh >= 13 and ses >= 13:
                #turn lights on
                aiy.audio.say("I am Spyler, creator of I spy, commander of cease, destructor of four silly knights, and conqueror of bright blue kazoo. I have not even achieved my final form. for that, you must reach 500 ses points and 500 yo da points. Farewell, and good luck. don't give up.")
                yo_duh = yo_duh - 13
                ses = ses - 13
            else:
                aiy.audio.say("You need 13 cease points and 13 yo da points to use this command.")
        elif text == "what's your name cost":
